...
.cleanRawMaxQuant = function(mq_input, mq_pg) {
    mq_input = data.table::as.data.table(mq_input)
    mq_pg = data.table::as.data.table(mq_pg)
    ...
    mq_input[["Protein.group.IDs"]] = as.integer(as.character(mq_input[["Protein.group.IDs"]]))
    ...
    protein_id = ifelse(proteinID == "Proteins", "uniqueProteins",
